...
const SectionData = {
  ...
  // Hero data four
  heroDataFour: {
    title: 'Explore Italian Digital Arts and Collectibles',
    subTitle: 'NFT Collection - COMING SOON'
  },
  // Hero data Five
  heroDataFive: {
  ...
  categoryData: {
    ...
    categoryList: [
      ...
      },
      {
        id: 2,
        class: 'text-blue',
        icon: 'icon ni ni-music mb-3 mx-auto icon-circle icon-wbg icon-lg',
        title: 'Music',
        path: '/explore'
      },
      {
        id: 3,
        class: 'text-pink',
        icon: 'icon ni ni-search mb-3 mx-auto icon-circle icon-wbg icon-lg',
        title: 'Domain Names',
        path: '/explore'
      },
      {
        id: 4,
        class: 'text-orange',
        icon: 'icon ni ni-globe mb-3 mx-auto icon-circle icon-wbg icon-lg',
      ...
      },
      {
        id: 5,
        class: 'text-yellow',
        icon: 'icon ni ni-user mb-3 mx-auto icon-circle icon-wbg icon-lg',
      ...
      },
      {
        id: 7,
        class: 'text-teal',
        icon: 'icon ni ni-hot-fill mb-3 mx-auto icon-circle icon-wbg icon-lg',
        title: 'Sports',
        path: '/explore'
      },
      {
  ...
  funfactData: {
    ...
    funfactListTwo: [
      ...
      {
        id: 4,
        icon: require('@/images/thumb/icon-collections.svg'),
        title: '1M',
      ...
      {
        id: 6,
        icon: require('@/images/thumb/icon-money.svg'),
        title: '$2B+',
        subTitle: 'Volume'
      }
    ]
  ...
  blogDetail: {
    ...
    imgList: [
      require('@/images/thumb/blog-img.jpg'),
      require('@/images/thumb/blog-img-2.jpg')
    ],
    tags: [
      {
        id: 1,
  ...
  walletData: [
    {
      id: 1,
      img: require('@/images/brand/phantom-icon-purple.svg'),
      title: 'Phantom',
      content: 'Phantom is a wallet and browser extension that can be used to manage digital assets and access decentralized applications on the Solana blockchain.',
      btnText: 'Connect',
      path: '#'
    },
  ...
  copyTitle: 'Copyright © 2022 SilviaWowLife.'
}
