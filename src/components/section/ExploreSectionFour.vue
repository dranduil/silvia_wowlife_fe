<template>
    <section class="explore-section section-space bg-primary-dark is-theme">
        <div class="container">
            <!-- filter -->
            ...
            <div class="row g-gs">
              <div class="col-xl-3 col-lg-4 col-sm-6" v-for="product in filteredData" :key="product.id">
                   <ProductsFour :product="product"></ProductsFour>
              </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- .container -->
...
import ProductsFour from '@/components/section/ProductsFour'
export default {
  name: 'ExploreSectionFour',
  components: { 
    ProductsFour 
  },
  data () {
