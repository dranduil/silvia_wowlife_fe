  ...
  <div class="page-wrap">
        ...
        <section class="user-panel-section section-space">
                <div class="container">
                    <div class="row">
                        <!-- user sidebar -->
                        <UserSidebar :title="SectionData.notificationSidebarData.title" :lists="SectionData.notificationSidebarData.navList" :navs="SectionData.notificationData.notificationTabNavMobile"></UserSidebar>
