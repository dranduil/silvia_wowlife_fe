...
<div class="page-wrap">
    ...
    <header class="header-section has-header-main">
        ...
        <AuthorHero avatarSize="avatar-3" :isCopyInput="true" :coverimg="collection.banner_image" :img="collection.author.profile_image" :title="collection.name" :username="collection.author.username" :btntext="collection.btnLink" :btnlink="collection.btnLink"></AuthorHero>
    </header>
    <!-- Collections -->
