...
<div class="page-wrap">
    ...
    <section class="user-panel-section section-space">
            <div class="container">
                <div class="row">
                    <!-- user sidebar -->
                    <UserSidebar :title="SectionData.activitySidebarData.title" :lists="SectionData.activitySidebarData.navList" :navs="SectionData.userActivityTabNavMobile"></UserSidebar>
                    <!-- offer -->
