...
<div class="page-wrap">
    <!-- header  -->
    <header class="header-section has-header-main bg-gradient-primary is-theme no-theme-switcher">
        <!-- Header main -->
        <HeaderMain isTransparent="is-transparent on-dark"></HeaderMain>
    </header>
    <section class="item-detail-section section-space bg-primary-dark is-theme">
        <div class="container">
            <div class="row">
